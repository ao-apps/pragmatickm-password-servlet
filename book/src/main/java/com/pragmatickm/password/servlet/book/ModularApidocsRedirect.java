...
package com.pragmatickm.password.servlet.book;
...
@WebServlet("/password/servlet/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/password/servlet/apidocs/com.pragmatickm.password.servlet/com" + Objects.toString(req.getPathInfo(), ""),
